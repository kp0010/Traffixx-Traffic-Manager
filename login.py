...
class login:
    def __init__(self,window):
        ...
        self.username_label = Label(self.lgn_frame,text='Username',bg='black',fg = '#4f4e4d',font=('Arail',13,'bold'))
        self.username_label.place(x=600,y=370)

        self.username_entry =Entry(self.lgn_frame,highlightthickness=0,relief=FLAT,bg ='black',fg='white',font=('Arail',13,'bold'))
        ...
        self.password_label = Label(self.lgn_frame,text='Password',bg='black',fg = '#4f4e4d',font=('Arail',13,'bold'))
        self.password_label.place(x=600,y=450)

        self.password_entry =Entry(self.lgn_frame,highlightthickness=0,relief=FLAT,bg ='black',fg='white',font=('Arail',13,'bold'))
        ...
        self.login = Button(self.lgn_button_label,text= 'LOGIN',font=('Arial',13,'bold'),width=25,bd=0,bg= '#3047ff',cursor='hand2',activebackground='#3047ff',activeforeground='red',fg='white')
        self.login.place(x=20,y=15)

        self.forgot_button = Button(self.lgn_frame,text= 'Forgot Password ?',font=('Arial',13,'bold underline'),width=25,bd=0,bg= 'black',cursor='hand2',activebackground='black',activeforeground='green',fg='white')
        self.forgot_button.place(x=640,y=570)

        self.sign_up_label = Label(self.lgn_frame,text='No account yet?',font=('Arial',13,'bold',),bg ='black',fg='white')
        ...
        self.sign_up_button_label = Button(self.lgn_frame,image = photo,bg= 'black',activebackground='black',cursor='hand2',bd=0)
